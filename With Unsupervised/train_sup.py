...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='weights_sup.pth',
    ...
    exp_lr_scheduler = lr_scheduler.ReduceLROnPlateau(optimizer, mode='max', factor=0.5, patience=5, verbose=True, min_lr=0.001)
    ...
    try:
        for epoch in range(args.epochs):
            ...
            if val_acc > best_acc:
                torch.save(model.state_dict(), 'weights_sup.pth')
                print("Weight Saved")
                best_acc = val_acc
